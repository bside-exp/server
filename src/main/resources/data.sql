-- # password = user
INSERT INTO user(username, password, nick_name, created_date, updated_date)
VALUES ('test@test.com', '$2a$10$VvmDU4Si9YyTwCyEFS8XOuvNPTXlK34/Wb0VoAfcZcEpLYVHPZACW', 'user', '2020-01-08 13:33:43',
        '2020-01-08 13:33:43');
